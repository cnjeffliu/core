 ...
 * @LastEditors: cnzf1
 * @LastEditTime: 2023-03-28 18:39:54
 * @Description:
 */
package set
...
type Set struct {
	data map[lang.AnyType]lang.PlaceholderType
	tp   int
}
...
func NewSet() *Set {
	return &Set{
		data: make(map[lang.AnyType]lang.PlaceholderType),
		tp:   untyped,
	}
}
...
func (s *Set) setType(i lang.AnyType) {
...
func (s *Set) validate(i lang.AnyType) {
	if s.tp == unknown {
		return
	}
