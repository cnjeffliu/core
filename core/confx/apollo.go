...
func TestApollo() {
	...
	// 	// ),
	// )
	err := agollo.Init("10.0.2.113:8080",
		"app-1",
		agollo.AutoFetchOnCacheMiss(),
		agollo.WithClientOptions(agollo.WithAccessKey("ee034b63dbe8491ca99e78dd607266ce")))
	if err != nil {
		panic(err)
	}
	...
	*/
	...
	fmt.Println("conf.log.name:", agollo.Get("conf.log.name"))
	fmt.Println("pub.db.host:", agollo.Get("pub.db.host", agollo.WithDefault("org1.ns-pub")))

	// 获取默认配置中cluster=default namespace=application key=timeout的值，提供默认值返回
	// fmt.Println("conf.log.dir:", agollo.Get("conf.log.dir", agollo.WithDefault("application")))
	...
	// 			fmt.Println("watch get:", agollo.Get("conf.log.name"))
	// 		}
	// 	}
	// }()
